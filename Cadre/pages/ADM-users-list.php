  ...
  <div class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-dark">
      <li class="dropdown-item" onclick="usr.addEdit(<?=$id?>)">
        <i class="mi mi-smol">Sửa</i> Sửa
      </li>
      <li class="dropdown-item" onclick="leave.entitle(<?=$id?>)">
        <i class="mi mi-smol">event_available</i> Nghỉ Phép Được Hưởng
      </li>
      <li class="dropdown-item text-warning" onclick="usr.del(<?=$id?>)">
        <i class="mi mi-smol">Xóa</i> Xóa
      </li>
    </ul>
  </div>
</div>
<?php }} else { echo "Không tìm thấy người dùng."; }
