...
<head>
  ...
  <?php if (isset($_SESS["user"])) { ?>
    ...
    <script>
      if ("serviceWorker" in navigator) {
        navigator.serviceWorker.register("<?= HOST_BASE ?>CB-worker.js", {
          scope: "<?= HOST_BASE_PATH ?>"
        });
      }
    </script>
  <?php } ?>
  ...
  <style>
    @font-face {
      ...
      font-style: normal;
      font-weight: 400;
      src: url(<?= HOST_ASSETS ?>maticon.woff2) format("woff2");
    }
          ...
          <div class="dropdownr">
            ...
            <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-end">
              ...
              <li><a class="dropdown-item" href="<?= HOST_BASE ?>account">
                  <i class="mi mi-smol">person</i> Tài khoản của tôi
                </a></li>
              <li class="dropdown-item text-warning" onclick="cb.bye()">
                <i class="mi mi-smol">logout</i> Đăng xuất
              </li>
            </ul>
          </div>
        </nav>
