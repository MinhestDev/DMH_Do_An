...
<h3 class="mb-3">ĐƯỢC QUYỀN NGHỈ CHO <?=strtoupper($user["user_name"])?></h3>
<form id="leave-form" onsubmit="return leave.save()">
  ...
  <input type="button" class="col btn btn-danger" value="Trở lại" onclick="cb.page(0)">
  <input type="submit" class="col btn btn-primary" value="Lưu">
</form>