...
<div class="d-flex align-items-center border p-2">
  <div class="flex-grow-1">
    ...
    <div><?=$l["leave_from"]?> đến <?=$l["leave_to"]?> (<?=LEAVE_TYPES[$l["leave_type"]]?>)</div>
